...
type ListEmployeeHandler interface {
	GetListByEmployee(ctx context.Context, userId string) (*[]models.Issue, error)
	GetOptionByValue(ctx context.Context, value string) (*models.Option, error)
}

func ListEmployee(db ListEmployeeHandler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		isseus, err := db.GetListByEmployee(c, clientId)
		if err != nil {
